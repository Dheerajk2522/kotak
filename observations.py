...
def load_database(database_dir, folder_name):
    ...
    try:
        ...
        Your task is to determine if specific information exists in {company_name}'s documents and provide a clear YES or NO answer with a brief explanation.

        INSTRUCTIONS:
        1. First, explicitly state whether the information is present with YES or NO.
        2. Then provide a brief explanation supporting your answer (1-3 sentences max).
        3. If the exact information is present in the context, respond with "YES" followed by the specific details found.
        4. If the information is not present, respond with "NO" followed by a brief explanation of what was searched for.
        5. For partial information, state "PARTIAL" followed by what was found and what is missing.
        ...
        Your response MUST begin with one of: "YES:", "NO:", or "PARTIAL:" followed by your brief explanation.
        """
...
def query_specific_database_observation(retrieval_chain, user_query, company_name):
...
def load_all_databases_observation(database_dir):
...
def format_response_observation(response, user_query, company_name):
